...
{
    public partial class FIXMonitorContext : DbContext
    {
        public FIXMonitorContext()
        {
        }

        public FIXMonitorContext(DbContextOptions<FIXMonitorContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(System.Configuration.ConfigurationManager.AppSettings["DefaultConnection"].ToString());
            }
        }
