...
namespace proto
{
    ...
    public struct Engine : IComparable, IComparable<Engine>, IEquatable<Engine>
    {
        ...
        public string FIXEngineIpAddress;
        public string FIXEngineIpPort;
        ...
        public Engine(string engineID, string engineName, ulong redisDB, string redisIpAddress, string redisIpPort, string FIXEngineIpAddress, string FIXEngineIpPort)
        {
            ...
            this.FIXEngineIpAddress = FIXEngineIpAddress;
            this.FIXEngineIpPort = FIXEngineIpPort;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append(",FIXEngineIpAddress="); if (FIXEngineIpAddress != null) sb.Append("\"").Append(FIXEngineIpAddress).Append("\""); else sb.Append("null");
            sb.Append(",FIXEngineIpPort="); if (FIXEngineIpPort != null) sb.Append("\"").Append(FIXEngineIpPort).Append("\""); else sb.Append("null");
            sb.Append(")");
            return sb.ToString();
        }
...
namespace FBE
{
    namespace proto
    {
        ...
        public class FieldModelEngine : FieldModelValueType<Engine>
        {
            ...
            public readonly FieldModelReferenceType<string> FIXEngineIpAddress;
            public readonly FieldModelReferenceType<string> FIXEngineIpPort;
            ...
            public FieldModelEngine(Buffer buffer, long offset) : base(buffer, offset)
            {
                ...
                FIXEngineIpAddress = FieldModelReferenceType<string>.CreateFieldModel(BaseTypes.STRING, buffer, redisIpPort.FBEOffset + redisIpPort.FBESize);
                FIXEngineIpPort = FieldModelReferenceType<string>.CreateFieldModel(BaseTypes.STRING, buffer, FIXEngineIpAddress.FBEOffset + FIXEngineIpAddress.FBESize);
            }
            ...
            public long FBEBody
            {
                get
                {
                    long fbeResult = 4 + 4
                        ...
                        + redisIpPort.FBESize
                        + FIXEngineIpAddress.FBESize
                        + FIXEngineIpPort.FBESize
                        ;
                    return fbeResult;
                }
            }
            ...
            public override long FBEExtra
            {
                get
                {
                    ...
                    long fbeResult = FBEBody
                        ...
                        + FIXEngineIpAddress.FBEExtra
                        + FIXEngineIpPort.FBEExtra
                        ;
            ...
            public bool VerifyFields(long fbeStructSize)
            {
                ...
                if ((fbeCurrentSize + FIXEngineIpAddress.FBESize) > fbeStructSize)
                    return true;
                if (!FIXEngineIpAddress.Verify())
                    return false;
                fbeCurrentSize += FIXEngineIpAddress.FBESize;

                if ((fbeCurrentSize + FIXEngineIpPort.FBESize) > fbeStructSize)
                    return true;
                if (!FIXEngineIpPort.Verify())
                    return false;
                fbeCurrentSize += FIXEngineIpPort.FBESize;
            ...
            public void GetFields(out Engine fbeValue, long fbeStructSize)
            {
                ...
                if ((fbeCurrentSize + FIXEngineIpAddress.FBESize) <= fbeStructSize)
                    FIXEngineIpAddress.Get(out fbeValue.FIXEngineIpAddress);
                else
                    fbeValue.FIXEngineIpAddress = "";
                fbeCurrentSize += FIXEngineIpAddress.FBESize;

                if ((fbeCurrentSize + FIXEngineIpPort.FBESize) <= fbeStructSize)
                    FIXEngineIpPort.Get(out fbeValue.FIXEngineIpPort);
                else
                    fbeValue.FIXEngineIpPort = "";
                fbeCurrentSize += FIXEngineIpPort.FBESize;
            }
            ...
            public void SetFields(Engine fbeValue)
            {
                ...
                FIXEngineIpAddress.Set(fbeValue.FIXEngineIpAddress);
                FIXEngineIpPort.Set(fbeValue.FIXEngineIpPort);
            }
        }
